	...
	return (
		<div className='w-full'>
			<p className='text-center text-muted-foreground text-sm'>
				We have sent a one-time verification code to your email address. Please enter the code below to verify your account.
			</p>
			<Form {...form}>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								<Label>Email</Label>
								<FormControl>
									<Input placeholder='Enter email adress' disabled className='h-10 bg-secondary' {...field} />
								</FormControl>
